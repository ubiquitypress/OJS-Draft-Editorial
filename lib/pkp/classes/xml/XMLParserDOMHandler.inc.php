...
class XMLParserDOMHandler extends XMLParserHandler {
	...
	/** @var XMLNode reference to the xxxxxx node */
	var $xxxxxxNode;
	...
	function XMLParserHandler() {
		$this->xxxxxxNodes = array();
		$this->currentNode = null;
	}

	function destroy() {
		unset($this->currentNode, $this->currentData, $this->xxxxxxNode);
	}
	...
	/**
	 * Returns a reference to the xxxxxx node of the tree representing the document.
	 * @return XMLNode
	 */
	function &getResult() {
		return $this->xxxxxxNode;
	}
}
