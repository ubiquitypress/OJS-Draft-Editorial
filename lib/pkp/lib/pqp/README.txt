...
For the most part, the example will work once you drop it in your xxxxxx directory. 
There are a few settings to check though.

- In PHPQuickProfiler.php, set the $config member variable to the path relative to your xxxxxx (located in the constructor).
