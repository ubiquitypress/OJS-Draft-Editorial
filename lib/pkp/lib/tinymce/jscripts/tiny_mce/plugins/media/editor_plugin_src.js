...
(function() {
	var xxxxxxAttributes = tinymce.explode('id,name,width,height,style,align,class,hspace,vspace,bgcolor,type'), excludedAttrs = tinymce.makeMap(xxxxxxAttributes.join(',')), Node = tinymce.html.Node,
	...
	tinymce.create('tinymce.plugins.MediaPlugin', {
			...
			ed.addCommand('mceMedia', function() {
				...
				if (isMediaImg(img)) {
					...
					if (data) {
						...
						tinymce.each(xxxxxxAttributes, function(name) {
		...
		dataToHtml : function(data, force_absolute) {
			return this.editor.serializer.serialize(this.dataToImg(data, force_absolute), {forced_xxxxxx_block : '', force_absolute : force_absolute});
		},
