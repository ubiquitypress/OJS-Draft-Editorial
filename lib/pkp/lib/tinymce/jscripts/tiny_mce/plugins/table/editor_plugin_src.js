		...
		init : function(ed, url) {
			...
			ed.onInit.add(function(ed) {
				...
				function tableCellSelected(ed, rng, n, currentCell) {
					...
					// required is actually a pointer to the xxxxxx cause of this bug. A cell is selected when the start 
				...
				// This fix will force a paragraph element after the table but only when the forced_xxxxxx_block setting is enabled
				if (!tinymce.isIE) {
