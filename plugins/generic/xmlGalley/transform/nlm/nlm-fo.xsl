...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <fo:xxxxxx font-size="{$body.font.size}" font-family="{$body.font.family},{$symbol.font.family}" text-align="justify" line-height="normal" font-selection-strategy="character-by-character" line-height-shift-adjustment="disregard-shifts">
